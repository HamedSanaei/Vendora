...
const OrderArea = ({
  ...
  return (
    <div className="your-order mb-30 ">
      <h3>{isFa ? "سفارش شما" : "Your order"}</h3>
      <div className="your-order-table table-responsive">
        <table>
          <thead>
            <tr>
              <th className="product-name">{isFa ? "محصول" : "Product"}</th>
              <th className="product-total text-end">{isFa ? "جمع" : "Total"}</th>
            </tr>
          </thead>
          <tbody>
        ...
        <div className="accordion" id="checkoutAccordion">
          <div className="accordion-item">
            <h2 className="accordion-header" id="checkoutOne">
              ...
              >
                {isFa ? "ثبت سفارش و پرداخت" : "Place order and payment"}
